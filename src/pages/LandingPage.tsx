    ...
    <div className="min-h-dvh overflow-x-hidden bg-surface-0 text-surface-900">
      <header className="sticky top-0 z-40 border-b border-surface-200/70 bg-surface-0/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link to="/landing" aria-label="Byou - página inicial" className="rounded-md focus-ring">
            <Logo className="text-xl" />
          </Link>
          <nav className="hidden items-center gap-7 text-sm md:flex">
            <a href="#vitrine" className="font-semibold text-surface-900 hover:text-brand-link">Explorar</a>
          ...
          <div className="relative mx-auto grid max-w-[1280px] items-center gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:gap-10 lg:px-8">
            <div className="lg:col-span-6">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a href="#vitrine" className="inline-flex h-12 items-center gap-2 rounded-md border border-surface-300 bg-surface-100 px-5 text-sm font-semibold text-surface-800 hover:bg-surface-200 focus-ring"><Play size={16} className="text-accent-ink" />Ver demonstração</a>
              </div>
